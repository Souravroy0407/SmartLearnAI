...
import { BrainCircuit, Mail, User, ArrowRight, Loader2, Sparkles } from 'lucide-react';
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        >
                            ...
                            <div className="relative transition-all duration-300 group-focus-within:scale-[1.01]">
                                ...
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 transition-colors group-focus-within:text-indigo-500 pointer-events-none" />
                                <input
                                    type="text"
                                    value={fullName}
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-2xl font-bold text-lg shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all flex items-center justify-center gap-2 group relative overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed mt-4"
                        >
